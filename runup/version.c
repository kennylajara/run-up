...
#define __PYX_HAVE__runup__version
#define __PYX_HAVE_API__runup__version
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'runup.version' */
#define __Pyx_MODULE_NAME "runup.version"
extern int __pyx_module_is_main_runup__version;
int __pyx_module_is_main_runup__version = 0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_u_0_1b4_1, __pyx_k_0_1b4_1, sizeof(__pyx_k_0_1b4_1), 0, 1, 0, 0},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_runup__version) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "runup.version")) {
      if (unlikely(PyDict_SetItemString(modules, "runup.version", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init runup.version", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init runup.version");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
